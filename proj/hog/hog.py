...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        if who == 0:
            ...
            roll = take_turn(num_rolls, score1, dice)
            score0 += roll
            if feral_hogs and abs(num_rolls - dice0) == 2:
                score0 += 3
            ...
            roll = take_turn(num_rolls, score0, dice)
            score1 += roll
            if feral_hogs and abs(num_rolls - dice1) == 2:
                score1 += 3
